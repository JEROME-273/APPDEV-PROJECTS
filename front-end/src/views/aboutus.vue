      ...
      <header class="header">
        ...
        <div class="icons">
          ...
          <div class="user-icon" @click="toggleDropdown">
            <img :src="user && user.profile_pic ? '/uploads/' + user.profile_pic : '/images/default-profile.png'" alt="User Profile" />
          </div>
  ...
  export default {
    data() {
      return {
        ...
        user: {
          profile_pic: null // You can replace this with actual user data
        }
      };
    },
    methods: {
