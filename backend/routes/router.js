...
router.get("/login", checkAlreadyLoggedIn, userController.getLoginPage);
...
router.post(
  "/profile",
  userController.handleProfilePicUpload,
...
router.get("/reset-password", userController.getResetPasswordPage); // Request reset form
router.post("/reset-password", userController.sendResetPasswordEmail); // Handle email submission
router.get("/reset-password/:token", userController.getNewPasswordPage); // Verify token
router.post("/reset-password/:token", userController.updatePassword); // Update password
...
router.post(
  "/admin/delete-cancelled-order/:order_id",
  adminController.deleteCancelledOrder
);
router.post(
  "/admin/clear-cancelled-orders",
  adminController.clearAllCancelledOrders
);
