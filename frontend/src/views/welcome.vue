  ...
  <div>
    ...
    <section class="about">
      <div class="about-item">
        ...
        <p>
          At AgriEcommerce, we are dedicated to enhancing the agricultural
          experience for both consumers and farmers through our comprehensive
          online marketplace. Here, you will find a diverse selection of
          high-quality seeds suitable for various crops, ensuring access to the
          best options for your gardening or farming needs.
        </p>
      </div>
      <div class="about-item">
        <h2>Capabilities</h2>
        ...
        <p>
          Our user-friendly platform ensures easy navigation for browsing and
          purchasing products, while direct farmer connections promote fair
          pricing and guarantee fresh produce. We actively educate customers on
          sustainable practices and provide dedicated customer support to ensure
...
export default {
  ...
  methods: {
    ...
    confirmLogout() {
      ...
      if (confirmation) {
        // Send GET request to backend to log out the user
        axios
          .get("/logout", { withCredentials: true })
          .then((response) => {
            if (response.data.successMsg) {
              alert(response.data.successMsg); // Optionally show a success message

              // Clear user data from local storage/session or cookies
